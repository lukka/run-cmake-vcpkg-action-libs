...
test('run-vcpkg must not build (i.e. running bootstrap) when the version of the repository is the same as the last built binary, and it must install successfully the ports.', async () => {
