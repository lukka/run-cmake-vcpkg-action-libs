...
export const packagePreset = 'packagePreset';
...
export const packagePresetFormat = 'packagePresetCmdString';
...
export const packagePresetAdditionalArgs = 'packagePresetAdditionalArgs';
